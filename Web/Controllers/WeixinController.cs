...
namespace Web.Controllers
{
    ...
    {
        public static readonly string Token = System.Configuration.ConfigurationManager.AppSettings["weixinTonken"].ToString();//与微信公众账号后台的Token设置保持一致，区分大小写。
        ...
        public ActionResult Post(PostModel postModel)
        {
            ...
            postModel.EncodingAESKey = System.Configuration.ConfigurationManager.AppSettings["EncodingAESKey"].ToString();//根据自己后台的设置保持一致
            postModel.AppId = System.Configuration.ConfigurationManager.AppSettings["AppId"].ToString();//根据自己后台的设置保持一致
            ...
            try
            {
                ...
                return new MvcExtension.Results.FixWeixinBugWeixinResult(messageHandler); //为了解决官方微信5.0软件换行bug暂时添加的方法，平时用下面一个方法即可
